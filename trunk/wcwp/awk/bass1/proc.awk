...
getxlsdata(){
				...
				data_mon=$2
				#step1:copy 28*p (Êµ¼Ê 1-28,a-p) data,to ue,->csv
				#step2:format data 0.000,save as voice_yyyymm.csv
				#step3:upload to unix /bassapp/bass1/panzw2/bass1
				...
				echo db2 "load client from /bassapp/bass1/panzw2/bass1/$voice_outputfile of del  insert into  bass1.T_GS05001M"
				db2 "load client from /bassapp/bass1/panzw2/bass1/$voice_outputfile of del  insert into  bass1.T_GS05001M"
				echo db2 "delete from bass1.T_GS05002M where time_id = ${data_mon}"
				db2 "delete from bass1.T_GS05002M where time_id = ${data_mon}"
				echo db2 "load client from /bassapp/bass1/panzw2/bass1/$sms_outputfile of del  insert into  bass1.T_GS05002M"
				db2 "load client from /bassapp/bass1/panzw2/bass1/$sms_outputfile of del  insert into  bass1.T_GS05002M"
				db2 connect reset
				db2 terminate
}
