...
EXEC_PATH=/bassdb2/etl/L/js
WORK_PATH=/bassdb2/etl/L/js
BACKUP_PATH=${WORK_PATH}/backup
ERROR_PATH=${WORK_PATH}/error
OBJ_PATH=/bassdb2/etl/L/boss
...
./ftp_interface.sh  10.233.23.60 load load /bassdb2/etl/L/js  /jiesuan/mthuss MTHUS${sday}891.???
