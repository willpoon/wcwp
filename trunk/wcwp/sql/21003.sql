...
rename bass1.G_S_21003_MONTH to G_S_21003_MONTH_20120607;
...
CREATE TABLE "BASS1   "."G_S_21003_MONTH_PK20120608"  (
                  "TIME_ID" INTEGER , 
                  "BILL_MONTH" CHAR(6) NOT NULL , 
                  "BRAND_ID" CHAR(1) NOT NULL , 
                  "SVC_TYPE_ID" CHAR(3) NOT NULL , 
...
CREATE TABLE "BASS1   "."G_S_21003_MONTH_PK201206083"  (
                  "TIME_ID" INTEGER , 
                  "BILL_MONTH" CHAR(6) NOT NULL , 
                  "BRAND_ID" CHAR(1) NOT NULL , 
                  "SVC_TYPE_ID" CHAR(3) NOT NULL , 
...
insert into G_S_21003_MONTH_PK201206083
select
         TIME_ID
        ,BILL_MONTH
        ,BRAND_ID
...
ksh  bass1_export_lite.sh G_S_21003_MONTH 201205 &
