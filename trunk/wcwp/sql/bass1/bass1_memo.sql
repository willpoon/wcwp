...
select * from  table( bass1.get_after('a_02008_day')) a 
...
select * from bass2.dw_product_20120322
where user_id = '89160000184970'
...
select count(0) from bass1.g_a_02008_day where time_id = 20120322

40064
40061


联通GSM当日离网用户数 785 726 
