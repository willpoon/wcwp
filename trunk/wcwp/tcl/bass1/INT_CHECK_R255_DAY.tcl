...
proc Deal { op_time optime_month province_id redo_number trace_fd bass1_dir temp_data_dir semi_data_dir final_data_dir conn conn_ctl src_data obj_data final_data } {
      ...
      puts $op_month				
        ...
        #程序名
        global app_name
        set app_name "INT_CHECK_R255_DAY.tcl"
...
"
   ...
   set RESULT_VAL3 [lindex $p_row 2]
        ...
        #--将校验值插入校验结果表
        set sql_buff "
                INSERT INTO BASS1.G_RULE_CHECK VALUES ($timestamp,'R255',$RESULT_VAL1,$RESULT_VAL2,$RESULT_VAL3,0) 
                "
                exec_sql $sql_buff
