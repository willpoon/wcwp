...
<anjuta>
    ...
    <plugin name="Task Manager" mandatory="no">
        <require group="Anjuta Plugin"
                 attribute="Location"
    ...
    <plugin name="Sample Plugin" mandatory="no">
        <require group="Anjuta Plugin"
                 attribute="Location"
                 value="anjuta-sample:SamplePlugin"/>
    </plugin>
    ...
    <plugin name="Class Inheritance" mandatory="no">
        <require group="Anjuta Plugin"
                 attribute="Location"
                 value="anjuta-class-inheritance:AnjutaClassInheritance"/>
    </plugin>
