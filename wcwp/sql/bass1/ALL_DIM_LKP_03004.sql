...
0
--~   (所有短信费)几乎无此科目的记录。把此科目剔除，不加入0602
...
--先更新 BASS_STD1_0152 为 BASS_STD1_0074	
...
and BASS1_TBID in ('BASS_STD1_0074','BASS_STD1_0152')
and xzbas_value not in ('82000038')
) a set BASS1_VALUE_desc = '国内点对点短信'
...
80000035
 select * from   BASS1.ALL_DIM_LKP
where xzbas_value in ('82000009','80000035','80000110','82000109')
