...
要想同时使用有线网上内网、无线网上外网 在cmd中执行：

route delete 0.0.0.0 

route add 0.0.0.0 mask 0.0.0.0 192.168.1.1

route add 10.13.4.0 mask 255.255.255.0 10.122.2.1

--route delete 0.0.0.0
route add 0.0.0.0 mask 0.0.0.0 192.168.1.1

其中192.168.1.1为无线网网关，10.122.2.1为有线网网关。这两句话的意思是：对于所有IP地址的访问，都从192.168.1.1走；但是，对于10.13.4开头的地址的访问，从10.122.2.1走。

注意 192.168.1.1为无线网网关，10.122.2.1为有线网网关 , 和这几句的意思！！ 


route add -p 172.16.0.0 mask 255.255.0.0 10.233.20.158

route add -p 120.132.0.0 mask 255.255.0.0 192.168.1.1
...
关于预发布2011年3月一经数据完好率考核成绩的通知 
发布人： 薛瑜琳 发布时间： 2011-4-21 17:58:00 
附 件：  
内 容： 
各省业务支撑部门：
...
现将2011年3月一级经营分析系统接口数据完好率考核成绩进行预发布，请尽快核实。

如有疑议，请于2011年4月22日17:00前完成申告，并提供必要的证明材料传真至010-66006452。



以下几点说明请大家注意：

1、由于支撑系统割接改造引起的影响及时性成绩情况，请在申告中说明即可，不用再发证明材料，集团公司会根据交流网站上割接申请的批复情况进行调整。

2、由于集团总部一侧原因导致的接口上传不及时，无需申告，集团公司统一调整。

3、请在传真的首页注明共有几页传真，以防遗漏。
...
db2 "delete from bass1.dim_trans_enterprise_id where enterprise_id is null with ur"
 ...
 tar cvf - /bassapp/bass1/panzw2/* | gzip -qc > 20120109.tar.gz
...
reorgchk current statistics on table PMID.TB_MID_ITC_SUM_DAY0812;
reorg table PMID.TB_MID_ITC_SUM_DAY0812 use tempspace2;
runstats on table PMID.TB_MID_ITC_SUM_DAY0812 with distribution;
reorgchk current statistics on table PMID.TB_MID_ITC_SUM_DAY0812;



reorgchk current statistics on table BASS1.G_S_21003_TO_DAY;
reorg table BASS1.G_S_21003_TO_DAY;
...
while read table
do
echo db2 runstats on table bass1.$table with distribution and detailed indexes all
db2 runstats on table bass1.$table with distribution and detailed indexes all
done<<!
INT_210012916_201112
G_S_04004_DAY
G_S_04005_DAY
G_I_03002_MONTH
G_I_03001_MONTH
G_S_03004_MONTH
INT_210012916_201201
G_S_04008_DAY
G_S_03002_MONTH_TYM
G_S_03005_MONTH
G_S_21003_MONTH
...
G_I_02053_MONTH
G_I_02049_MONTH
G_I_02006_MONTH_20110120
INT_CHECK_ONLINE_USER_TMP3
G_I_21020_MONTH
G_S_21008_MONTH
G_A_02011_DAY
G_I_02006_MONTH
G_A_02004_02008_STAGE
G_S_22302_DAY
G_S_04014_DAY
G_A_02004_DAY_IMSI
G_S_03002_MONTH
...
G_A_02004_DAY
G_S_04010_DAY
G_A_02004_DAY_LASTEST
G_S_04015_DAY
G_S_04002_DAY_TD
G_S_02048_MONTH_CANCEL_OLD
G_I_22404_MONTH
INT_02004_02008_MONTH_STAGE
G_S_21001_DAY
G_S_03014_MONTH
G_I_02021_MONTH_TEMP2
TD_CHECK_USER_STATUS_LS
INT_02004_02008_MONTH_STAGE_201109
TD_USER
INT_02011_SNAPSHOT
G_S_21012_MONTH
TD_USER_1
...
G_S_04007_DAY
G_A_01001_DAY
INT_CHECK_ONLINE_USER_TMP2
CHECK_TEMP_02004_NOW
CHECK_TEMP_02008_NOW
CHECK_0200402008_DAY_2
CHECK_TEMP_02004_LAST
CHECK_TEMP_02008_LAST
CHECK_0200402008_DAY_3
G_A_02052_MONTH
JITUAN_01002_1
JITUAN_01002
G_I_02015_MONTH
...
MONTH_02006_MID1
G_S_09906_MONTH
INT_02004_02008_201001
INT_02004_02008_201101
INT_02004_02008_201103
G_S_22303_MONTH
G_A_02008_DAY_TAKE
G_I_02021_MONTH_TEMP1
G_S_22067_MONTH_1
G_S_22404_MONTH
INT_02004_02008_201002
MONTH_02006_MID2
INT_02004_02008_201006
G_A_02059_DAY
G_S_21003_MONTH_MOBILE
INT_CHECK_ONLINE_USER_TMP
G_S_03010_DAY
T_PRODUCT_NO
G_USER_LST
G_I_02005_MONTH
...
DB2_DB2_01      60000/tcp
DB2_DB2_01_1    60001/tcp
DB2_DB2_01_2    60002/tcp
DB2_DB2_01_END  60003/tcp
db2c_DB2_01	50000/tcp
db2c_DB2	50001/tcp
DB2	50001/tcp



C:\Users\Administrator\Documents\PROD_EXPC.rsp
...
特定于安装的驱动程序详细信息            
用于 ODBC 和 CLI 的 IBM 数据服务器驱动程序的名称：   IBM DB2 ODBC DRIVER - DB2COPY1
OLE DB 提供程序 GUID：                     {955778C6-9FF9-444C-8C60-60EC25FC449A}
...
响应文件名：                               C:\Users\Administrator\Documents\PROD_EXPC.rsp
...
要验证安装文件、实例和数据库功能，请运行验证工具 C:\DB2EXPC\bin\db2val.exe。有关更多信息，请参阅 DB2 信息中心中的 "db2val"。
...
入藏一载，日光之城，又值春暖花开，勃勃生机，周游猎艳之季，吾又将成为非洲黑人鸟!
...
ignore list:
 ...
 C:\Users\poon\downloads\Windows Kits\8.0\StandaloneSDK
 
 
为了减少频繁告警，把05001 挂到02032上，这个关系随时可以删除！
delete from  app.sch_control_before
...
do
echo $filename
/bassapp/bass1/tcl/int -s $filename > /bassapp/bihome/panzw/tmp/tclrunlog/$filename.batch 2>&1
done<<!
INT_CHECK_R037toR039_MONTH.tcl
INT_CHECK_B67_MONTH.tcl
!

INT_CHECK_IMPORTSERV_MONTH.tcl
INT_CHECK_L5_MONTH.tcl
INT_CHECK_R060_MONTH.tcl
INT_CHECK_R229_MONTH.tcl
INT_CHECK_X0123_MONTH.tcl
INT_CHECK_R008_MONTH.tcl
INT_CHECK_R024_MONTH.tcl
INT_CHECK_F7_MONTH.tcl
INT_CHECK_R032_MONTH.tcl
INT_CHECK_R034_MONTH.tcl
INT_CHECK_R040_MONTH.tcl
INT_CHECK_R057_MONTH.tcl
INT_CHECK_R036_MONTH.tcl
INT_CHECK_R208_MONTH.tcl
INT_CHECK_06031_MONTH.tcl
INT_CHECK_E5_MONTH.tcl
INT_CHECK_R061_MONTH.tcl
INT_CHECK_R181_MONTH.tcl
INT_CHECK_R192_MONTH.tcl
INT_CHECK_R235_MONTH.tcl
INT_CHECK_R031_MONTH.tcl
INT_CHECK_R058_MONTH.tcl
INT_CHECK_0204902004_MONTH.tcl
INT_CHECK_R009_MONTH.tcl
INT_CHECK_R055_MONTH.tcl
INT_CHECK_R059_MONTH.tcl
INT_CHECK_R221_MONTH.tcl
INT_CHECK_R026_MONTH.tcl
INT_CHECK_R028_MONTH.tcl
INT_CHECK_R029_MONTH.tcl
INT_CHECK_R056_MONTH.tcl
INT_CHECK_R238_MONTH.tcl
INT_CHECK_R256_MONTH.tcl
INT_CHECK_G047TO50_MONTH.tcl
INT_CHECK_R216_MONTH.tcl
INT_CHECK_R255_MONTH.tcl
INT_CHECK_R006_MONTH.tcl
INT_CHECK_R025_MONTH.tcl
INT_CHECK_TD_MONTH.tcl
INT_CHECK_02006_MONTH.tcl
INT_CHECK_98Z6_MONTH.tcl
INT_CHECK_R027_MONTH.tcl
INT_CHECK_R062_MONTH.tcl
INT_CHECK_0200803005_MONTH.tcl
INT_CHECK_R030_MONTH.tcl
