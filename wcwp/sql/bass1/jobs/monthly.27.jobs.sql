#替换：
#1.DIM_TERM_TAC_20120228BAK
#2.i_30000_201108_91005_001
---------------处理91005接口数据问题------------------------------
RENAME TABLE BASS2.DIM_TERM_TAC TO DIM_TERM_TAC_20120228BAK;
...
datafilename=i_30000_201202_91005_001.dat
...
TERMPROD_NAME,
NET_TYPE,
TERM_TYPE from BASS2.DIM_TERM_TAC_20120228BAK
where net_type <>'2';
...
select tac_nuM,count(*) from BASS2.DIM_TERM_TAC_20120228BAK
group by tac_nuM
having count(*)>1
0
...
select * from BASS2.DIM_TERM_TAC_20120228BAK
where tac_nuM='35805102'
...
select count(0) from    BASS2.DIM_TERM_TAC
 27790
 select count(0) from    bass2.DIM_TERM_TAC_20120228BAK
 27776
