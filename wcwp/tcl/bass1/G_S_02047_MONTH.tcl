...
#编写时间：2009-05-05
#问题记录：
#修改历史: 20090710 liuzhilong  修改程序 命名G_I_02047_MONTH 改为 G_S_02047_MONTH ,20090805 排除历史离网用户
#          20100124 口径修改 userstatus_id in (0,4,5,7) 修改为userstatus_id in (0,4,5,7,9)
#######################################################################################################
...
proc Deal { op_time optime_month province_id redo_number trace_fd bass1_dir temp_data_dir semi_data_dir final_data_dir conn conn_ctl src_data obj_data final_data } {
        ...
        #删除正式表本月数据
        set sql_buff "delete from bass1.G_S_02047_MONTH where time_id=$op_month"
        puts $sql_buff
        exec_sql $sql_buff
        ...
        set sql_buff "insert into bass1.CDR_CALL_DM_MID
                       ...
                       group by user_id,product_no,imei with ur"
        puts $sql_buff
        exec_sql $sql_buff
        ...
        #往正式表插入本月数据
        set sql_buff "insert into bass1.G_S_02047_MONTH
                      select $op_month,a.user_id,a.product_no,a.imei,char(a.cnt) from bass1.CDR_CALL_DM_MID a,
                        (
