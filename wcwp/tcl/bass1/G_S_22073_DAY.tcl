...
##~   }
##~   20120825 	  set sqlbuf "		update (		select * from G_S_22073_DAY where time_id=int(replace(char(current date - 1 days),'-',''))		) t 		set TEL_FIX_ARRIVE_CNT = char(bigint(TEL_FIX_ARRIVE_CNT)  - 1750 - 272 + 658 + 303 ) /* + ${vCount} */	  "	  exec_sql $sqlbuf	  
##############################################
	return 0      
}   
