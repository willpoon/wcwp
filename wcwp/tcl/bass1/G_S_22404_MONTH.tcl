...
#接口名称: 校园区域本网用户短信交往圈                                                               
#接口编码：22404                                                                                          
#接口说明："校园区域本网用户发送点对点短信的所有对端号码（包含竞争对手号码）集合。"
#程序名称: G_S_22404_MONTH.tcl                                                                            
#功能描述: 生成22404的数据
#运行粒度: MONTH
#源    表：1.
#输入参数: void
...
puts $this_month_last_day
  ...
  #程序名
  global app_name
  set app_name "G_S_22404_MONTH.tcl"
        
  #删除本期数据
	set sql_buff "delete from bass1.G_S_22404_MONTH where time_id=$op_month"
  exec_sql $sql_buff
...
set sql_buff "ALTER TABLE g_s_22404_month_2 ACTIVATE NOT LOGGED INITIALLY WITH EMPTY TABLE"
exec_sql $sql_buff


set sql_buff "
insert into g_s_22404_month_2
select 
	$op_month
	,user_id
	,product_no
...
set sql_buff "delete from g_s_22404_month_1 where op_time = $timestamp"
exec_sql $sql_buff

set sql_buff "
insert into g_s_22404_month_1
		    	  select
				 $timestamp,
		    	  	 b.user_id,
		    	  	 b.product_no,
