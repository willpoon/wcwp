#***********************************************************************************************************************************************
# ** 程序名称：INT_CHECK_R029_MONTH.tcl
# ** 程序功能：一经校验程序（R029）
# ** 运行示例：int INT_CHECK_R029_MONTH.tcl
# ** 创建时间：2009-5-30 15:03:29
# ** 创 建 人：xufr
# ** 规则编号：R029
# ** 规则属性：业务逻辑
# ** 规则类型：月
# ** 指标摘要：欠费记录表中的帐户标识
# ** 规则描述：欠费记录表中的帐户标识都应存在于账户表中
# ** 校验对象：03007 欠费记录
# **           03001 帐户
# ** 输出参数：返回值:   0 成功; -1 失败
# ** 修改历史:
...
proc Deal { op_time optime_month province_id redo_number trace_fd bass1_dir temp_data_dir semi_data_dir final_data_dir conn conn_ctl src_data obj_data final_data } {
	...
	if { $RESULT_VAL1 > 0 } {
		set grade 2
		set alarmcontent "准确性指标R029超出集团考核范围"
