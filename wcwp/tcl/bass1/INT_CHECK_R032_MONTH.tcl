#***********************************************************************************************************************************************
# ** 程序名称：INT_CHECK_R032_MONTH.tcl
# ** 程序功能：一经校验程序（R032）
# ** 运行示例：int INT_CHECK_R032_MONTH.tcl
# ** 创建时间：2009-5-31 15:46:22
# ** 创 建 人：xufr
# ** 规则编号：R032
# ** 规则属性：业务逻辑
# ** 规则类型：月
# ** 指标摘要：综合账单中的用户的用户业务类型编码
# ** 规则描述：综合账单中的用户在用户表中“用户业务类型编码”类型为1（由于西藏已不存在智能网用户，因此只判断用户表中的业务类型编码是否有不为01的）
# ** 校验对象：03005 综合帐单
# **           02004 用户
# ** 输出参数：返回值:   0 成功; -1 失败
# ** 修改历史:
...
proc Deal { op_time optime_month province_id redo_number trace_fd bass1_dir temp_data_dir semi_data_dir final_data_dir conn conn_ctl src_data obj_data final_data } {
	...
	if { $RESULT_VAL1 > 0 } {
		set grade 2
		set alarmcontent "准确性指标R032超出集团考核范围"
