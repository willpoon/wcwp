#***********************************************************************************************************************************************
# ** 程序名称：INT_CHECK_R042_MONTH.tcl
# ** 程序功能：一经校验程序（R042）
# ** 运行示例：int INT_CHECK_R042_MONTH.tcl
# ** 创建时间：2009-5-30 10:09:28
# ** 创 建 人：xufr
# ** 规则编号：R042
# ** 规则属性：业务逻辑
# ** 规则类型：月
# ** 指标摘要：实体渠道日汇总和实体渠道月汇总的新增客户数差异
# ** 规则描述：实体渠道日汇总接口中的当月汇总新增客户数与实体渠道月汇总接口中当月新增客户数的差异率应在3%内
# ** 校验对象：22053 实体渠道日汇总
# **           22054 实体渠道月汇总
# ** 输出参数：返回值:   0 成功; -1 失败
# ** 修改历史:
...
proc Deal { op_time optime_month province_id redo_number trace_fd bass1_dir temp_data_dir semi_data_dir final_data_dir conn conn_ctl src_data obj_data final_data } {
	...
	if { [ expr 1.000 * ($RESULT_VAL1 - $RESULT_VAL2) / $RESULT_VAL1 ] > 0.03 || [ expr 1.000 * ($RESULT_VAL2 - $RESULT_VAL1) / $RESULT_VAL2 ] > 0.03 } {
		set grade 2
		set alarmcontent "准确性指标R042超出集团考核范围"
