#***********************************************************************************************************************************************
# ** 程序名称：INT_CHECK_R049_MONTH.tcl
# ** 程序功能：一经校验程序（R049）
# ** 运行示例：int INT_CHECK_R049_MONTH.tcl
...
# ** 规则类型：月
# ** 指标摘要：实体渠道新增客户数
# ** 规则描述：实体渠道月汇总接口中新增客户数应等于自营渠道业务量情况接口和社会渠道业务情况接口中新增客户数之和
# ** 校验对象：22054 实体渠道月汇总
# **           22046 自营渠道业务量情况
# **           22047 社会渠道业务情况
# ** 输出参数：返回值:   0 成功; -1 失败
...
proc Deal { op_time optime_month province_id redo_number trace_fd bass1_dir temp_data_dir semi_data_dir final_data_dir conn conn_ctl src_data obj_data final_data } {
	...
	#判断R049：实体渠道月汇总接口中新增客户数 = 自营渠道业务量情况接口新增客户数 + 社会渠道业务情况接口新增客户数
	if { [ expr $RESULT_VAL2 + $RESULT_VAL3 ] != $RESULT_VAL1 } {
		set grade 2
		set alarmcontent "准确性指标R049超出集团考核范围"
